import 'package:fit_start_app/screens/onboarding_age.dart';
...
class _OnboardingWeightState extends State<OnboardingWeight> with TickerProviderStateMixin {
  ...
  void _handleNext() {
    ...
    if (weight == null || weight <= 0) {
      ...
      final data = PreferencesService.loadUserData();
      PreferencesService.saveUserData(
        data['height'] ?? 0.0,
        weight,
        data['age'] ?? 0,
      );
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('FitStart Onboarding', style: TextStyle(color: Colors.white)),
      ...
      body: Stack(
        children: [
          Positioned.fill(
            child: CustomPaint(painter: _WavePainter(animation: _controller)),
          ),
            ...
            child: AnimatedBuilder(
              ...
              builder: (context, child) {
                return Transform.translate(
                  offset: Offset(0, -40 * _pushUpAnimation.value),
                  child: Opacity(
